    ...
    <div class="dashboard-app">
        ...
        <main class="main-area">
            ...
            $this->load->view('admin/partials/header', array(
                ...
                'header_description' => 'Control the core settings used by the records management system.',
                'header_stat_label' => 'System settings',
                'header_stat_value' => count($settings),
            ...
            <div class="system-content">
                <!-- Compact System navigation follows the shared page header. -->
