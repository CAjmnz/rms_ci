...
<!-- VIEWER FIX: version string added so future edits to this file are not cached indefinitely. -->
<script src="<?php echo base_url('assets/js/rms-document-workspace.js?v=20260825-viewer-fix-v1'); ?>"></script>
