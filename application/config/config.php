...
|--------------------------------------------------------------------------
| Sets Philippine time for all PHP date and time functions in the RMS.
| This prevents date() timezone warnings across every CI3 module.
*/
date_default_timezone_set('Asia/Manila');

/*
|--------------------------------------------------------------------------
| User Portal Activity Log
|--------------------------------------------------------------------------
|
| Stores only successful document View and Download actions made through the
| CI3 User Portal. Keeping this separate protects both legacy RMS log files.
|
*/
$config['portal_activity_log_path'] = APPPATH . 'logs' . DIRECTORY_SEPARATOR . 'portal_activity.log';
